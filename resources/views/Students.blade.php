        ...
        <table class="table-auto border-collapse w-full">
            ...
            <tbody class="text-sm font-normal text-gray-700">
                <tr class="hover:bg-gray-100 border-b border-gray-200">
                    <td class="px-4 py-4">20241001</td>
                    <td class="px-4 py-4">John</td>
                    <td class="px-4 py-4">Doe</td>
                    <td class="px-4 py-4">Male</td>
                    <td class="px-4 py-4">123-456-7890</td>
                    <td class="px-4 py-4">123 Main St, City</td>
                </tr>
                <tr class="hover:bg-gray-100 border-b border-gray-200">
                    <td class="px-4 py-4">20241002</td>
                    <td class="px-4 py-4">Jane</td>
                    <td class="px-4 py-4">Smith</td>
                    <td class="px-4 py-4">Female</td>
                    <td class="px-4 py-4">987-654-3210</td>
                    <td class="px-4 py-4">456 Elm St, Town</td>
                </tr>
            </tbody>
        </table>
    </div>
